...
## Update 2!!
Something happen when uploading the package. It does not identify Neo.JsonRpc.RpcClient as a dependency of the project. So you have to install both the Neo.RPC and Neo.JsonRpc.RpcClient packages until I fix this!
